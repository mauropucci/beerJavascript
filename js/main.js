...
var idMarca = "";
var oldIdMarca = "";
var oldRecordsPerPage=9;



function setPagination(id) {
	oldRecordsPerPage = recordsPerPage;
...
function RicercaBirre(page) {
	...
	oldIdMarca = idMarca;
	oldRecordsPerPage = recordsPerPage;
	idCitta = document.getElementById("IdCitta").value;
	idMarca = document.getElementById("IdMarca").value;
	recordsPerPage = document.getElementById("IdRecords").value;
	
	if(idCitta != oldIdCitta || idMarca != oldIdMarca || recordsPerPage != oldRecordsPerPage) {
		page=1;
	}
